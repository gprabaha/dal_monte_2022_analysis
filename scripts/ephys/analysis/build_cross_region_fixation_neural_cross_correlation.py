...
def main() -> None:
    ...
    cli_partner_regions = _as_str_list(args.partner_region)
    cli_include_regions = _as_str_list(args.include_region)
    if args.anchor_region is not None:
        settings.anchor_region = str(args.anchor_region)
    if cli_partner_regions is not None:
        settings.partner_regions = cli_partner_regions
