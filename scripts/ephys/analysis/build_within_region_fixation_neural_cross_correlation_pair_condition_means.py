"""Build within-region date-level pair-condition mean neural xcorr outputs."""
...
def _print_analysis_summary(signal_column: str, signal_summary: dict[str, object]) -> None:
    ...
    print(
        "[analysis] within-region pair-condition means "
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build within-region date-level pair-condition mean neural xcorr outputs.",
    )
