...
def main() -> None:
    ...
    settings = FixationPeakinessPlotSettings(
        ...
        figure_height_in=cfg.get("peakiness_plot_figure_height_in", 4.0),
        left_margin=float(cfg.get("peakiness_plot_left_margin", 0.08)),
        right_margin=float(cfg.get("peakiness_plot_right_margin", 0.995)),
        top_margin=float(cfg.get("peakiness_plot_top_margin", 0.92)),
        bottom_margin=float(cfg.get("peakiness_plot_bottom_margin", 0.20)),
        violin_width=float(cfg.get("peakiness_plot_violin_width", 0.86)),
        show_points=bool(cfg.get("peakiness_plot_show_points", True)),
        ...
        highlight_annotation_fontsize=float(cfg.get("peakiness_plot_highlight_annotation_fontsize", 7.5)),
