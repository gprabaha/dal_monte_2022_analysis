...
def _feature_metadata_from_context(obj, fallback: dict) -> dict:
    ...
    return {**fallback, **{key: value for key, value in meta.items() if value is not None}}
...
def load_feature_modality(
    ...
    *,
    ...
    """Backward-compatible alias for loading one feature modality as a DataFrame."""
