...
from dal_monte_2022_analysis.ephys.analysis.fixation_signal_correlation import (
    ...
    correlate_signal_with_spike_correlation,
    join_with_spike_correlation,
)
...
from dal_monte_2022_analysis.ephys.analysis.fixation_pair_spike_coordination import (
    ...
    OBSERVED_METRIC,
    ABOVE_NULL_METRIC,
    WINDOW_METRIC as SPIKE_WINDOW_METRIC,
    MATCHED_WINDOW_METRIC as SPIKE_MATCHED_WINDOW_METRIC,
    compare_conditions,
